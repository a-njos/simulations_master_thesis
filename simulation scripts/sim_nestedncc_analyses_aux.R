...
# setup -----------------------
setup= "aux"
filepath="simulations/standard/"  # same cohort as standard
nimp= 10 
n.it = 100
npara=3
nsim= 1000
...
sm_formula_full = "Surv(t,d)~x+z1+z2+v"
sm_formula_ncc = "Surv(t,case)~x+z1+z2+v+strata(setno)"
...
for(j in seq(1,nsim)){
  ...
  # Compute Nelson-Aalen estimate of the cumulative hazard for  the superset
  cohort.ncc$chaz = nelsonaalen(cohort.ncc,t,d)
  ...
  res_mat[j,] = c(res_full,res_ncc,
                  res_aprx,res_aprx_sup,res_aprx_sup_nai,
