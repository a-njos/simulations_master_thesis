...
library(latex2exp)
SAVE_PLOTS=T
if(SAVE_PLOTS) pdf("figures/sim/cchstdest.pdf",width=8,height=16) 
par(mfrow=c(4,2))
...
if(SAVE_PLOTS) pdf("figures/sim/cchstdestz1.pdf",width=8,height=16) 
par(mfrow=c(4,2))
...
if(SAVE_PLOTS) pdf("figures/sim/cchstdestz2.pdf",width=8,height=16) 
par(mfrow=c(4,2))
